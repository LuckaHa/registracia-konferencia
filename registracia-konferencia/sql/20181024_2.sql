...
--
-- Host: localhost    Database: registracia-itat
-- ------------------------------------------------------
...
CREATE TABLE `companion` (
  ...
  `tshirt` enum('XS','S','M','L','XM') DEFAULT NULL,
...
INSERT INTO `participant` VALUES (1,'Andrej','Danko','predseda@parlament.sk','NR SR','BA parlament',7,'A007',0,0,1,'2018-09-21 16:00:00','2018-09-23 11:00:00',0,'XL',1);
...
CREATE TABLE `workshop` (
  ...
  `start` date NOT NULL,
  `end` date NOT NULL,
  `pricefull` decimal(6,2) DEFAULT NULL,
  `pricestudent` decimal(6,2) DEFAULT NULL,
  `pricefulllate` decimal(6,2) DEFAULT NULL,
  `pricestudentlate` decimal(6,2) DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `workshop` VALUES (1,'Combinatorics on words','2018-09-21','2018-11-23',245.00,195.00,265.00,210.00);
...
-- Dump completed on 2018-10-24  8:38:23
